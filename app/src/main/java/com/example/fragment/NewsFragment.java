...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bt_search = view.findViewById(R.id.btn_search);
        recyclerView = view.findViewById(R.id.news_recy);
           ...
           public void onClick(View v) {
               if (!etQuery.getText().toString().equals("")){
                   swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                       @Override
                       public void onRefresh() {
                           getArticles(etQuery.getText().toString(),contry,API_KEY);
                       }
                   });
                   getArticles(etQuery.getText().toString(),contry, API_KEY);
               }else {
...
return view;
    ...
    public void getArticles(String Query, String country, String apikey) {
